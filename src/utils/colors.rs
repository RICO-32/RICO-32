...
impl COLORS {
    ...
    pub const RED: COLORS     = COLORS(255, 0, 0, 255);
    pub const LIME: COLORS    = COLORS(0, 255, 0, 255);
    pub const BLUE: COLORS    = COLORS(0, 0, 255, 255);
    pub const YELLOW: COLORS  = COLORS(255, 255, 0, 255);
    pub const CYAN: COLORS    = COLORS(0, 255, 255, 255);
    pub const MAGENTA: COLORS = COLORS(255, 0, 255, 255);
    ...
    pub const GREEN: COLORS   = COLORS(0, 128, 0, 255);
